...
public class Solution
{
    ...
    //Un número complejo, es una entidad matemática que viene dada por un par de números reales, el primero a se
    // denomina la parte real y al segundo b la parte imaginaria.
    ...
    //La clase Complejo contendrá un constructor por defecto que inicializará a 0 los atributos y un constructor
    // con dos parámetros correspondientes a los valores de la parte real e imaginaria a asignar al nuevo objeto.
    ...
    //La clase contendrá además un método toString para mostrar el número complejo de la siguiente forma:
    // (parte real, parte imaginaria) y un método equals que compruebe si dos números complejos son iguales o no.
